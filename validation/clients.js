...
const client = Joi.object({
    ...
    NUIS : Joi.string().min(10).max(30).required().messages({
        ...
        'string.max':   `"NUIS" duhet te ket nje maksimum prej 30 karakteresh`,
    ...
    logoVirtualPath : Joi.string().min(10).max(20).required().messages({
        ...
        'string.max':   `"logoVirtualPath" duhet te ket nje maksimum prej 30 karakteresh`,
    ...
    vat : Joi.string().min(3).max(20).required().messages({
        ...
        'string.max':   `"vat" duhet te ket nje maksimum prej 30 karakteresh`,
    ...
    TCRCode : Joi.string().min(3).max(20).required().messages({
        ...
        'string.max':   `"kodi tcr" duhet te ket nje maksimum prej 30 karakteresh`,
        'any.required': `"kodi tcr" eshte nje fushe e detyrueshme`
    }),
    softCode : Joi.string().min(3).max(20).required().messages({
        'string.base':  `"vat" duhe te jet i formatit 'tekst'`,
        'string.empty': `"vat" nuk duhet te jet bosh`,
        'string.min':   `"vat" duhet te ket nje limit prej 10 karakteresh`,
        'string.max':   `"vat" duhet te ket nje maksimum prej 30 karakteresh`,
    ...
    signature : Joi.string().min(3).max(20).required().messages({
        'string.base':  `"signature" duhe te jet i formatit 'tekst'`,
        'string.empty': `"signature" nuk duhet te jet bosh`,
        'string.min':   `"signature" duhet te ket nje limit prej 10 karakteresh`,
        'string.max':   `"signature" duhet te ket nje maksimum prej 30 karakteresh`,
    ...
    certificate : Joi.string().min(3).max(20).required().messages({
        'string.base':  `"vat" duhe te jet i formatit 'tekst'`,
        'string.empty': `"vat" nuk duhet te jet bosh`,
        'string.min':   `"vat" duhet te ket nje limit prej 10 karakteresh`,
        'string.max':   `"vat" duhet te ket nje maksimum prej 30 karakteresh`,
    ...
    typeOfTCR : Joi.string().min(3).max(20).required().messages({
        'string.base':  `"vat" duhe te jet i formatit 'tekst'`,
        'string.empty': `"vat" nuk duhet te jet bosh`,
        'string.min':   `"vat" duhet te ket nje limit prej 10 karakteresh`,
        'string.max':   `"vat" duhet te ket nje maksimum prej 30 karakteresh`,
